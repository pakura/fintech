...
<div class="page-title">
    <div class="title-env">
        <h1 class="title">
            <i class="{{$iconCurrent = icon_type('catalog')}}"></i>
            {{ $parent->type }}
        </h1>
...
@push('body.bottom')
@include('admin._scripts.move', ['route' => cms_route('catalog.move', [$parent->id]), 'column' => 'collection_id', 'list' => $parentSimilar, 'parentId' => $parent->id])

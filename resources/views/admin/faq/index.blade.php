...
<div class="page-title">
    <div class="title-env">
        <h1 class="title">
            <i class="{{$iconCurrent = icon_type('faq')}}"></i>
            {{ $parent->type }}
        </h1>
    ...
    <div class="col-md-9 pull-right has-sidebar">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <a href="{{ cms_route('faq.create', [$parent->id]) }}" class="btn btn-secondary btn-icon-standalone">
                    <i class="{{$iconCurrent}}"></i>
...
$(function() {
@if ($parent->admin_order_by == 'position')
    positionable('{{ cms_route('faq.updatePosition') }}', '{{$parent->admin_sort}}', '{{request('page', 1)}}', '{{$items->hasMorePages()}}');
@endif
});
</script>
